...
2. An approved and ACTIVE methodology profile for a live case.
3. RBE-001 Reference Architecture v1.1.0.
4. Normative v1.1.0 registers and approved architecture decisions.
...
- its permitted subset of RBE substantive outcomes;
